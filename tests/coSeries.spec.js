...
describe('co.series()', function() {
    ...
    describe('pipe', function() {
        it('Should fail if args param is not an object', function() {
            inspect(co.pipe).withArgs().doesThrow(/valid object/);
        });

        it.skip('Should call functions in series', function(done) {
            var func1 = function(a, b, c, done) {
                done(null, a);
            }
            var func2 = function(a, b, c, done) {
        ...
        it.skip('Should call promises in series', function(done) {
            var func1 = function(a, b, c, promise) {
                promise.resolve(a);
            }
            var func2 = function(a, b, c, promise) {
        ...
        it.skip('Should call promise returning function in series', function(done) {
            var func1 = function(a, b, c) {
                return Promise.resolve(a);
            }
            var func2 = function(a, b, c) {
        ...
        it.skip('Should call generators in series', function(done) {
            var gen1 = function *(a, b, c) { return a; };
            var gen2 = function *(a, b, c) { return b; };
            var gen3 = function *(a, b, c) { return c; };
